...
@RestController
@RequestMapping("/api/test-admin-kafka")
public class TestAdminKafkaResource {
    private final Logger log = LoggerFactory.getLogger(TestAdminKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public TestAdminKafkaResource(KafkaProperties kafkaProperties) {
